...
{
  const char* tag = checkenv("LBNL_FIT_P17B") ? "by_Beda"
    : (checkenv("LBNL_FIT_BLINDED") ? "v4v5v3v1_blinded" : "v4v5v3v1_unblinded");
  return LeakStr("../ReactorPowerCalculator/isotope_spectra_%s/reactor_%s%s.txt",
