...
void fit_shape_2d_P17B_toyMC(TString sig_spectra_filename0 = "./Spectra/ibd_eprompt_shapes_6ad.root",
			     TString sig_spectra_filename1 = "./Spectra/ibd_eprompt_shapes_8ad_p14a.root",
                 TString sig_spectra_filename2 = "./Spectra/ibd_eprompt_shapes_8ad_p14a.root",
			     TString acc_spectra_filename0 = "./Spectra/accidental_eprompt_shapes_8ad_full.root",
			     TString acc_spectra_filename1 = "./Spectra/accidental_eprompt_shapes_8ad_full.root",
                 TString acc_spectra_filename2 = "./Spectra/accidental_eprompt_shapes_8ad_full.root",
			     Char_t input_filename0[256] = "./Inputs/Theta13-inputs_P15A_inclusive_6ad.txt",
			     Char_t input_filename1[256] = "./Inputs/Theta13-inputs_P15A_inclusive_8ad.txt",
                 Char_t input_filename2[256] = "./Inputs/Theta13-inputs_P15A_inclusive_8ad.txt",
			     Char_t histogram_filename[256] = "./Flux/SuperHistograms_P15A_P14Aperiod_fine_huber-french.root",
			     Char_t savefilename[256] = "./fit_result_files/fit_shape_2d_P15A_P14Aperiod.root",
  ...
  //Char_t Theta13InputsLocation[1][1024] = {"./Inputs/Theta13-inputs_P15A_P14Aperiod_inclusive_BCW.txt"};
  ...
  //TString AccidentalSpectrumLocation[1] = {"./Spectra/accidental_eprompt_shapes_P15A_P14Aperiod.root"};
