...
void minuit_fcn(Int_t &npar, Double_t *gin, Double_t &f, Double_t *x, Int_t iflag){ // function for minuit minimization
  ...
  //cout << "sin22t13: " << sin22t13 << " dm2_ee: " << dm2_ee << endl;
    //double dm2ee_central=0.00252;
    //double dm2ee_uncer=0.00007;
    double dm2ee_central=0.002485;//T2K value
    double dm2ee_uncer=0.000064;
  f =  pred->CalculateChi2Cov(sin22t13,dm2_ee, 0, -1) + pow((dm2ee_central-dm2_ee)/dm2ee_uncer,2);
}

Double_t CalculateChi2(TH1F *h_s22t13,TH1F* h_data);

void fit_shape_2d_P17B_IHEPdata_dm221(//(0=6AD, 1=8AD, 2=7AD, -1=6+8+7AD, 7=6+8AD)
		       double s22t13_grid = 0.,
               double dm2_21_grid = 0.,
               Char_t savefilename[256] = "./fit_result_files/fit_shape_2d_2017Model_P17B_IHEP_BCWbin_dm221.root",
               Int_t PeriodFlag = -1,
               TString sig_spectra_filename0 = "./Spectra/ibd_eprompt_shapes_6ad_IHEP_BCWbin.root",
		       TString sig_spectra_filename1 = "./Spectra/ibd_eprompt_shapes_8ad_IHEP_BCWbin.root",
               TString sig_spectra_filename2 = "./Spectra/ibd_eprompt_shapes_7ad_IHEP_BCWbin.root",
		       TString acc_spectra_filename0 = "./Spectra/accidental_eprompt_shapes_6ad_IHEP_BCWbin.root",
		       TString acc_spectra_filename1 = "./Spectra/accidental_eprompt_shapes_8ad_IHEP_BCWbin.root",
               TString acc_spectra_filename2 = "./Spectra/accidental_eprompt_shapes_7ad_IHEP_BCWbin.root",
		       Char_t input_filename0[256] = "./Inputs/Theta13-inputs_P17B_inclusive_6ad_IHEP.txt",
		       Char_t input_filename1[256] = "./Inputs/Theta13-inputs_P17B_inclusive_8ad_IHEP.txt",
               Char_t input_filename2[256] = "./Inputs/Theta13-inputs_P17B_inclusive_7ad_IHEP.txt",
		       Char_t fn_filename[256] = "../fn_spectrum/P15A_fn_spectrum_IHEP.root",
		       Char_t histogram_filename[256] = "./Flux/SuperHistograms_P17B_2017Model_fine_huber-french_IHEP_official.root",
		       bool isMC = false,
               ...
               Char_t sig_matrix_filename[256] = "covariance_matrices/matrix_sigsys_2017Model_P17B_IHEP_official_BCWbin.txt",
               Char_t bg_matrix_filename[256] = "covariance_matrices/matrix_bgsys_2017Model_P17B_IHEP_official_BCWbin.txt"){
  ...
  fluxcalc->osccalc->SetDeltaM2_21(dm2_21_grid);
  ...
  pred->LoadPredictedIBD("./PredictedIBD/PredictedIBD_P17B_2017Model_fine_huber-french_IHEP_official.root");
  ...
  pred->LoadEvisToEnuMatrix("./matrix_evis_to_enu_fine_2017Model_P17B_IHEP_official_BCWbin.txt");
