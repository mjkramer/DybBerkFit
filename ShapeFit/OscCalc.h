...
public:
  ...
  void OscSpecBinInt(double L, double s22t13, TH1F* anspec, TH1F* anspeosc,
                     int term = -1);
  ...
  double GetTheta12();
  double GetTheta14();
  // note: default parameters are only for those independent ones (for example,
  // knowing hierarchy and deltam2_32 you can get deltam2_31)
