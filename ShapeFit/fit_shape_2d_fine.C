...
void minuit_fcn(Int_t &npar, Double_t *gin, Double_t &f, Double_t *x, Int_t iflag){ // function for minuit minimization
  ...
  f =  pred->CalculateChi2Cov(sin22t13,dm2_ee, 0, -1, PeriodFlag);
}

Double_t CalculateChi2(TH1F *h_s22t13,TH1F* h_data);

void fit_shape_2d_fine(bool isMC = false,
                  ...
                  Char_t savefilename[256] = "./fit_result_files/fit_shape_2d_fine.root",
		  TString sig_spectra_filename0 = "./Spectra/ibd_eprompt_shapes_6ad.root",
		  TString sig_spectra_filename1 = "./Spectra/ibd_eprompt_shapes_8ad.root"){
  ...
  */
  ...
  const Int_t nsteps_dm2 = 51;
  //const Int_t nsteps_dm2 = 1;
  Double_t dm2eestart=2.0e-3;
  Double_t dm2eeend=3.0e-3;
  ...
  for(int ievt=0;ievt<Nevts;++ievt){
	...
	chi2result[step_dm2][step]=pred->CalculateChi2Cov(sin22t13[step_dm2][step],dm2ee[step_dm2][step],0,-1,PeriodFlag);
