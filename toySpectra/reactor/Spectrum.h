...
public:
  ...
  // Return the non-linearity corrected positron detected spectrum (events /
  // MeV)
  ...
  // load bg spectra (they have different binning to the ones used by ShapeFit,
...
private:
  ...
  double m_detectorDistance[Ndetectors]
                           [Ncores]; // Distance from reactor to detector
  ...
  double
      m_detectorResolution_error_uncorr; // Detector energy resolution parameter
  double m_detectorResolution_bias[Ndetectors]; // Random biases of the detector
                                                // resolution.
  ...
  double m_detectorEfficiency_dmc[Nstage][Ndetectors];    // Detector efficiency
                                                          // for DMC cut
  double m_detectorEfficiency_muveto[Nstage][Ndetectors]; // Detector efficiency
                                                          // for muon veto
  ...
  IsotopeTable* m_isotopes[Nstage]
                          [Ncores]; // Isotope tables for each different cores
