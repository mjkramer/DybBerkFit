...
private:
  ...
  double m_FissionFractionErr1D[MAX_ISOTOPE_ID]; // 1 dimensional relative error
                                                 // of the fission fraction
  double m_FissionFractionErr[MAX_ISOTOPE_ID]
                             [MAX_ISOTOPE_ID]; // Covariance matrix for the
                                               // fission fraction
